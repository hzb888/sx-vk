...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    j: common_vendor.o(($event) => _ctx.vk.navigateTo("../../openapi/weixin/weixin")),
    k: common_vendor.o(($event) => _ctx.vk.navigateTo("../../openapi/qq/qq")),
    l: common_vendor.o(($event) => _ctx.vk.navigateTo("../../openapi/douyin/douyin")),
    m: common_vendor.o(($event) => _ctx.vk.navigateTo("../../openapi/alipay/alipay")),
    n: common_vendor.o(($event) => _ctx.vk.navigateTo("../../openapi/baidu/baidu"))
  };
}
